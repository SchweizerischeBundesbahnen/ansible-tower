...
IMAGELIST=('base' 'jenkins-slave-base' 'jenkins-master' 'jenkins-slave-js' 'jenkins-slave-mobile-android' 'jenkins-slave-jee' 'jenkins-slave-wmb' 'jenkins-slave-iib9' 'jira-standalone' 'jrebellicenseserver' 'confluence' 'stash-base' 'stash-internal' 'gitrpm')
