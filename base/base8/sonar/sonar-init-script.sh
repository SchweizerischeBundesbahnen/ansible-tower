...
opts=" -p 8110:8110 -p 9110:9110 -p 10110:10110 -v /var/data/sonar/logs/:/opt/sonar/logs/ -e ${APP_URL} -e MYSQL_HOST=v01030.sbb.ch -e MYSQL_DBNAME=sonar_i -e MYSQL_USER=sonar_i -e MYSQL_PASSWORD=sonar_i -d "
